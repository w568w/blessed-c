...
|Neural Networks| [**fann**](https://github.com/libfann/fann) <br> Multi-layer artificial neural network library. Inactive for a long time. <br> [**Darknet**](https://github.com/pjreddie/darknet) <br> Fast CNN library from YOLO author. Unmaintained for a long time.|
